...
public class MaksukorttiTest {
    ...
    public void negatiivisenSummanLataaminenEiMuutaKortinSaldoa() {
        kortti = new Maksukortti(-5);
        assertEquals("Kortilla on rahaa 10.0 euroa", kortti.toString());
    }
    
    @Test
    public void voiSyodaEdullisestiKunKortillaOnRahaaVainEdullisenLounaanVerran() {
    ...
    @Test
    public void voiSyodaMaukkaastiKunKortillaOnRahaaVainEdullisenLounaanVerran() {
